    ...
    internal class Program
    {
        ...
        static List<int> DepthFirstSearch(BinaryTree graph, int targetNodeIndex)
        {
            ...
            do
            {
                ...
                else if (currentNode.children[1] != null && currentNode.visitedChildren.Count == 1)
                {
                    currentNode.visitedChildren.Add(currentNode.children[1]);
                    currentNode = currentNode.children[1];
                }
                else if (currentNode.children[0] == null || currentNode.visitedChildren.Count == 2)
                {
