...
namespace ClassPlayground
{
    internal class Program
    {
        ...
        static void RectanglePlayground()
        {
            ...
            {
                case "1":
                    Console.WriteLine("napiš délku, výšku");
                    Console.WriteLine("délka: ");
                    int width = int.Parse(Console.ReadLine());
                    Console.WriteLine("výška: ");
                    int height = int.Parse(Console.ReadLine());
                    Rectangle rectangle = new Rectangle(width,height);
                    Console.WriteLine($"obsah obdélníku je {rectangle.CalculateArea().ToString()}");
                    Console.WriteLine($"obdélník je {rectangle.CalculateAspectRatio()}");
                    Console.WriteLine("zadej x");
                    int x = int.Parse(Console.ReadLine());
                    Console.WriteLine("zadej y");
                    int y = int.Parse(Console.ReadLine());
                    Console.WriteLine(rectangle.ContainsPoint(x, y));
                    break;
                case "2":
                    Console.WriteLine("napiš délku hrany");
                    Rectangle square = new Rectangle(int.Parse(Console.ReadLine()));
                    Console.WriteLine($"obsah obdélníku je {square.CalculateArea()}");
                    Console.WriteLine($"obdélník je {square.CalculateAspectRatio()}");
                    Console.WriteLine("zadej x");
                    int x1 = int.Parse(Console.ReadLine());
                    Console.WriteLine("zadej y");
                    int y2 = int.Parse(Console.ReadLine());
                    Console.WriteLine(square.ContainsPoint(x1, y2));
                    break;
            }
